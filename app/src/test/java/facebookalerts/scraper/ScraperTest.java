...
public class ScraperTest {
    ...
    // KeywordRecord keyword = new KeywordRecord("sentient", Arrays.asList(new
    // String[] { "test@test.com" }));

    // String htmlLocation =
    // "file:///home/mmarian/dev/facebook-alerts/app/src/test/resources/GroupPage.html";

    // FacebookGroupRecord group = new FacebookGroupRecord(htmlLocation,
    // "yesterday",
    // Arrays.asList(new KeywordRecord[] { keyword }));

    // Map<String, List<String>> notifications = scraper.getUserNotifications(group,
    // yesterday);

    // assertNotNull(notifications.get("test@test.com"));

    // assertTrue(notifications.get("test@test.com").get(0).contains("Recently there
    // has been a lot of noise"));
    // }
